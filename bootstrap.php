...
$driverChain->addDriver($annotationDriver, 'Fidelix');
...
// )->bind('autorizacao');
//Area restrita
$app->mount('/restrito/empresa', new Fidelix\Backend\Controller\EmpresaController($em));
//Area publica
$app->mount('/site', new Fidelix\Backend\Controller\SiteController($em));
